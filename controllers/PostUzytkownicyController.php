...
/**
 * PostUzytkownicyController implements the CRUD actions for Uzytkownicy model.
 */
class PostUzytkownicyController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new PostUzytkownicy();
